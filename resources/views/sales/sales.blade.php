               ...
               <div class="row">
                    <div class="col-md-4" style="border-right: 1px solid #ccc; min-height:75vh">
                        <div class="input-group mb-3 mt-2 p-2">
                            ...
                            <input type="search" name="searchhistory" id="searchhistory" class="form-control searchfield" placeholder="Search by transaction id">
             ...
             <div class="row">
                <div class="col-md-4 p-2"  style="border-right: 1px solid #ccc; min-height:75vh;">
                    <div class="input-group mb-3 mt-2 p-2">
                        ...
                        <div class="form-floating">
                          <input type="search" class="form-control searchfield" id="searchpendingsales" placeholder="Search by transaction id">
                        ...
                        <tbody>
                            @foreach ($held_transactions as $held_transaction)
                                <tr>
                                    ...
                                    <td>{{\Carbon\Carbon::parse($held_transaction->created_at)->format('d/m/Y g:i A')}}</td>
